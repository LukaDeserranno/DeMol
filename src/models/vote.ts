...
export interface VotingRound {
  id: string;
  name: string;
  description?: string | null; // Description of the round (optional)
  startDate: Date;
  endDate: Date;
  isActive: boolean;
  episodeNumber: number;
  status: 'upcoming' | 'active' | 'closed' | 'archived'; // Current status of the round
  eliminatedCandidateId?: string | null; // ID of the candidate eliminated in this round (if any)
  eliminationDate?: Date | null; // When the elimination occurred
  theme?: string | null; // Theme or special focus of this episode
  votingStats?: {
